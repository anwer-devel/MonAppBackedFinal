...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleAccountLocked(AccountStatusException ex) {
        return buildResponse(HttpStatus.FORBIDDEN, "Compte suspendu ou inactif");
    }
